...
public class CatalogItemTest {
    ...
    CatalogItem catalogItem = new CatalogItem("R-1", 300, Arrays.asList(
            new AudioFeatures("Night Visions", 185, Arrays.asList("Dan Raynolds", "Imagine Dragons")),
            new PrintedFeatures("Harry Potter", 600, Arrays.asList("J.K. Rowling")),
            new AudioFeatures("Piece of Mind", 200, Arrays.asList("Steve Harris", "Iron Maiden")))
    );
